...
* [lunchmoney-python](https://github.com/juftin/lunchmoney-clients) - A generated Python SDK for the v2 API by Justin Flannery, author of the popular lunchable client. - (by Justin Flannery)
...
* [Lunch Money iOS Widget](https://github.com/berndsalewski/lunch-money-widget) - An iOS widget for Lunch Money statuses, giving you a budget overview at a glance. - (by Bernd Salewski)
